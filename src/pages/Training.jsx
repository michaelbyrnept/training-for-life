...
export default function Training() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f7f5f2", paddingBottom: "140px" }}>
      ...
      {showUpgradeGate && (
        <PremiumGate reason="generic" onClose={() => setShowUpgradeGate(false)} />
      )}

      {selectingType && (
        <div
          onClick={(e) => {
            if (e.target === e.currentTarget) setSelectingType(null);
          }}
          style={{
            position: "fixed",
            inset: 0,
                ...
                return (
                  <div
                    ...
                    style={{
                      padding: "14px 16px",
                      borderRadius: "14px",
                      border: `1.5px solid ${isSelected ? "#2d6a4f" : "#e5e5e5"}`,
                      backgroundColor: isSelected ? "#eaf5ef" : "#fff",
